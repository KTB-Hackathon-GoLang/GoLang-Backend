...
public class ChatController {
	...
	public ResponseEntity<ApiResponse<ChatroomInfo>> saveDetails(ChatroomMakeDetailRequest request) {
	...
	public ResponseEntity<ApiResponse<?>> saveOtherDetails(ChatroomMakeDetailRequest request){
		ChatroomInfo response = chatService.saveDetails(request);
